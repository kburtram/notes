...
**Code truth:** vscode-mssql `dev/query` @ `99a44957c`; sqltoolsservice `dev/query` @ `7532d145`. Everything described here is implemented and tested unless explicitly marked *gap* or *future*.
